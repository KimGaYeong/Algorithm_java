...
public class bj19228 {
    ...
    private static int solve(int guest) {
        // 도착지점
        int sr = customer[guest][0];
        int sc = customer[guest][1];
        int er = customer[guest][2];
        int ec = customer[guest][3];
    ...
    private static int find_distance(int sr, int sc) {
